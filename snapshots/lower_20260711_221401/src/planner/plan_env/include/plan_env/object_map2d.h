...
struct ObjectClusterSummary {
  int id = -1;
  int best_label = -1;
  double best_score = 0.0;
  double target_score = 0.0;
  int best_observation_count = 0;
  int target_observation_count = 0;
  int cell_count = 0;
  int good_cell_count = 0;
  Vector2d center = Vector2d::Zero();
  Vector2d box_min2d = Vector2d::Zero();
  Vector2d box_max2d = Vector2d::Zero();
  Vector3d box_min3d = Vector3d::Zero();
  Vector3d box_max3d = Vector3d::Zero();
};
...
public:
  ...
  void getObjectSummaries(vector<ObjectClusterSummary>& summaries) const;
