...
class ROSPublisher:
    def __init__(self):
        ...
        self.rgb_raw_pub = rospy.Publisher("/habitat/camera_rgb_raw", Image, queue_size=10)
    ...
    def habitat_publish_ros_topic(self, observations):
        ...
        raw_rgb_image = observations["rgb_raw"] if "rgb_raw" in observations else rgb_image
        ...
        self.publish_rgb_raw(ros_time, raw_rgb_image)
